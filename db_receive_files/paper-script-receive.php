<?php
    ...
    if($result = mysqli_query($connection,$query))
    {
        ...
        if($cnt>0){
            ...
            echo '<h3>Paper Setter and Script Examiner Information</h3>';
            echo '</div>';
            ...
            echo '<div class="download-button"><button class="btn btn-danger" onclick="excel_download(4)">Excel Sheet</button><div class="clearfix"></div></div>';
            echo '</div>';
            echo '</div>';
        }
    }            
