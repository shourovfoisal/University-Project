   ...
   unset($returnedResult);
    ...
    if($result = mysqli_query($connection,$query))
    {
        ...
        if($cnt>0){
            ...
            echo '<h3>Viva Information</h3>';
            echo '</div>';
            echo '<div class="panel-body">';
            echo '<div class="result-table table-responsive">';
            echo '<table id="viva-board" class="table">';
            echo '<thead>';
            echo '<tr>';
            echo '<th>SERIAL</th>';
            ...
            echo '<div class="download-button"><button class="btn btn-danger" onclick="excel_download(10)">Excel Sheet</button><div class="clearfix"></div></div>';
            echo '</div>';
            echo '</div>';
        }
    }           
